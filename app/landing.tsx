...
export default function Landing() {
        ...
        timeline.to(cursorRef.current, {
            ...
            .to(subtextRef.current, {
                duration: 5, scrambleText: {
                    text: "A CS Grad and a Full Stack Web Developer", chars: SCRAMBLE_CHARS, revealDelay: 0.8, speed: 0.3,
                }
            });
    ...
    return (<>
        <section className="flex flex-col items-center text-white text-sm">
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    <a href="https://prebuiltui.com" className="flex items-center gap-2 leading-none">
                        <Image
                            ...
                            priority
                        />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="inline-block h-auto w-40"
                             viewBox="-2 -2 275 55">
                            <path
            ...
            <h1 className="text-center text-5xl mt-32 gap-2 leading-17 md:text-6xl md:leading-[70px] font-semibold max-w-2xl">
                <span ref={ titleRef }></span>
                <span className="inline-block ml-1" ref={ cursorRef }>|</span>
            </h1>
            <p className="text-center text-3xl max-w-lg mt-2">
