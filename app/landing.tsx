...
export default function Landing() {
    ...
    return (<>
        <section className="flex flex-col items-center text-white text-sm">
            ...
            <nav
                className="z-50 flex items-center justify-between w-full py-4 md:px-16 lg:px-16 xl:px-32 backdrop-blur">
            ...
            <div className="h-18 mt-16">
                { showScrollDownHint && (<a href="#Skills">
                        <DotLottieReact
                            ...
                            themeData={ JSON.stringify({
                                primary: "#323936ff", secondary: "#8b1818ff",
                            }) }
                        />
                    </a>) }
            </div>
